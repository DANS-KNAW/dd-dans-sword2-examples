...
public class SequenceContinuedDeposit {
    ...
    public static void main(String[] args) throws Exception {
        ArgumentParser parser = ArgumentParsers.newFor("SequenceContinuedDeposit").build()
            .defaultHelp(true)
        ...
        URI baseUri = ContinuedDeposit.depositBagDir(bagDirInTarget, uri, uid, pw, chunkSize);
        ...
        for (int i = 1; i < bagNames.length; ++i) {
            ...
            ContinuedDeposit.depositBagDir(bagDirInTarget, uri, uid, pw, chunkSize);
        }
        System.exit(0);
    }
}
